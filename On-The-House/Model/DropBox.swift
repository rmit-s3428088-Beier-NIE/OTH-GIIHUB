...
class DropBox: UIView {
    ...
    init(parentVC: UIViewController, title: String, items: [String], frame: CGRect) {
       ...
       // self.boxButton.
        ...
        let xConstraint = NSLayoutConstraint(item: listTableView, attribute: .centerX, relatedBy: .equal, toItem: self.superview, attribute: .centerX, multiplier: 1, constant: 0)
        let yConstraint = NSLayoutConstraint(item: listTableView, attribute: .centerY, relatedBy: .equal, toItem: self.superview, attribute: .centerY, multiplier: 1, constant: 0)
        listTableView.addConstraint(xConstraint)
        listTableView.addConstraint(yConstraint)
    }
